...
/* ═══ EXERCISE DATA ═══ */
const DEFAULT_DAYS=[
{id:"mo",label:"Mo",title:"Oberkörper + Core",pauseEx:60,warmup:[{name:"Cat-Cow",detail:"60 Sek.",desc:"Vierfüßlerstand einnehmen, Hände unter den Schultern, Knie unter der Hüfte. Beim Einatmen Bauch nach unten sinken lassen und Blick nach oben (Cow). Beim Ausatmen Rücken rund machen, Kinn zur Brust ziehen (Cat). Fließend zwischen beiden Positionen wechseln.",yt:"cat+cow+übung+anleitung+deutsch"},{name:"World's Greatest Stretch",detail:"40 Sek./Seite",desc:"Großen Ausfallschritt machen, hinteres Bein gestreckt. Eine Hand neben den vorderen Fuß setzen, die andere Hand zur Decke drehen. Blick folgt der oberen Hand. Tiefe Position halten und in die Dehnung atmen.",yt:"worlds+greatest+stretch+anleitung"},{name:"Schulter-CARs",detail:"30 Sek./Arm",desc:"Aufrecht stehen, einen Arm langsam in einem möglichst großen Kreis nach vorne, oben, hinten und zurück führen. Kontrollierte, langsame Bewegung über den maximalen Bewegungsradius. Schulter aktiv durch alle Positionen rotieren.",yt:"shoulder+CARs+mobility+übung+anleitung"}],main:[{name:"Knie-Liegestütze",detail:"3×40 Sek.",desc:"Hände schulterbreit aufstellen, Knie am Boden, Füße angehoben. Körper bildet eine gerade Linie von Kopf bis Knie. Langsam absenken bis die Brust fast den Boden berührt, dann kontrolliert hochdrücken. Ellbogen ca. 45° vom Körper.",yt:"knie+liegestütze+anfänger+richtige+ausführung",tag:"Brust"},{name:"Tisch-Rudern",detail:"3×40 Sek.",desc:"Eine stabile Tischkante mit beiden Händen schulterbreit greifen. Füße nach vorne stellen, Körper schräg unter den Tisch. Brust kontrolliert zur Tischkante ziehen, Schulterblätter zusammenziehen. Langsam wieder ablassen.",yt:"bodyweight+row+tisch+rudern+zuhause",tag:"Rücken"},{name:"Stuhl-Dips",detail:"3×35 Sek.",desc:"Mit dem Rücken zum Stuhl, Hände auf die Stuhlkante setzen, Finger zeigen nach vorne. Beine angewinkelt oder gestreckt vor dem Körper. Arme beugen bis die Ellbogen etwa 90° erreichen, dann hochdrücken. Schultern bleiben unten.",yt:"stuhl+dips+trizeps+übung+anleitung",tag:"Trizeps"},{name:"Pike Push-ups",detail:"3×30 Sek.",desc:"Hände und Füße auf den Boden, Hüfte hoch in eine umgekehrte V-Form. Kopf zwischen den Armen Richtung Boden senken, indem die Ellbogen gebeugt werden. Kontrolliert zurückdrücken. Trainiert gezielt die Schultern.",yt:"pike+push+up+ausführung+deutsch+anleitung",tag:"Schultern"},{name:"Hollow Body Hold",detail:"3×30 Sek.",desc:"Auf den Rücken legen, Arme über den Kopf strecken, Beine geschlossen anheben. Der untere Rücken bleibt fest am Boden gedrückt. Arme und Beine schweben wenige Zentimeter über dem Boden. Bananenform halten, Bauch fest anspannen.",yt:"hollow+body+hold+anleitung+anfänger+core",tag:"Bauch"},{name:"Superman Hold",detail:"3×30 Sek.",desc:"Bauchlage, Arme nach vorne gestreckt. Gleichzeitig Arme, Brust und Beine vom Boden abheben. Gesäß fest anspannen, Blick zum Boden. Position halten ohne den Rücken zu überstrecken.",yt:"superman+übung+rücken+anleitung+bodyweight",tag:"Rücken"},{name:"Plank",detail:"3×30 Sek.",desc:"Auf die Unterarme stützen, Ellbogen direkt unter den Schultern. Körper bildet eine gerade Linie von Kopf bis Fersen. Bauch aktiv einziehen, Gesäß leicht anspannen, nicht ins Hohlkreuz fallen.",yt:"plank+unterarmstütz+richtige+ausführung",tag:"Core"}],cooldown:[{name:"Brustdehnung Türrahmen",detail:"40 Sek./Seite",desc:"Unterarm im 90°-Winkel an einen Türrahmen legen, Ellbogen auf Schulterhöhe. Einen Schritt nach vorne machen und den Oberkörper sanft durch die Tür drehen. Die Dehnung in der Brust und vorderen Schulter spüren.",yt:"brustdehnung+türrahmen+anleitung"},{name:"Kindshaltung",detail:"45 Sek.",desc:"Knie am Boden, Gesäß auf die Fersen setzen, Oberkörper nach vorne ablegen. Arme weit nach vorne strecken, Stirn auf dem Boden. Tief in den Rücken atmen und komplett loslassen.",yt:"childs+pose+yoga+anleitung+deutsch"},{name:"Kobra-Stretch",detail:"30 Sek.",desc:"Bauchlage, Hände neben der Brust aufstellen. Arme langsam strecken und den Oberkörper anheben. Hüfte und Beine bleiben am Boden. Sanfte Dehnung in der Bauchmuskulatur spüren, nicht überstrecken.",yt:"cobra+stretch+yoga+rücken+anleitung"}]},
{id:"di",label:"Di",title:"Unterkörper + Core",pauseEx:45,warmup:[{name:"Cat-Cow",detail:"45 Sek.",desc:"Vierfüßlerstand, beim Einatmen Bauch senken und Blick heben, beim Ausatmen Rücken runden und Kinn zur Brust. Fließend zwischen beiden Positionen wechseln.",yt:"cat+cow+übung+anleitung+deutsch"},{name:"Hüft-CARs",detail:"30 Sek./Bein",desc:"Aufrecht stehen, ein Knie anheben und in einem möglichst großen Kreis nach außen, oben und zurück rotieren. Langsam und kontrolliert über den maximalen Bewegungsradius der Hüfte arbeiten.",yt:"hip+CARs+mobility+übung+hüfte"},{name:"Tiefe Kniebeuge",detail:"45 Sek.",desc:"Füße etwas weiter als schulterbreit, Fersen fest am Boden. So tief wie möglich in die Hocke gehen, Ellbogen gegen die Innenseite der Knie drücken um die Hüfte zu öffnen. Rücken gerade halten.",yt:"deep+squat+hold+mobility+deutsch"}],main:[{name:"Kniebeugen",detail:"3×40 Sek.",desc:"Füße schulterbreit, Zehen leicht nach außen. Hüfte nach hinten-unten schieben als würde man sich auf einen Stuhl setzen. Mindestens bis zur Parallele gehen, Knie in Zehenrichtung. Rücken bleibt gerade, Brust offen.",yt:"bodyweight+kniebeugen+richtige+ausführung",tag:"Beine"},{name:"Reverse Lunges",detail:"3×30 Sek./Seite",desc:"Aufrecht stehen, einen großen Schritt nach hinten machen. Beide Knie beugen bis das hintere Knie fast den Boden berührt. Oberkörper bleibt aufrecht. Durch die Ferse des vorderen Fußes zurück in den Stand drücken.",yt:"reverse+lunges+anleitung+auf+der+stelle",tag:"Beine"},{name:"Glute Bridges",detail:"3×35 Sek.",desc:"Rückenlage, Füße hüftbreit aufgestellt, Arme neben dem Körper. Durch die Fersen drücken und die Hüfte anheben bis Schultern, Hüfte und Knie eine Linie bilden. Gesäß oben fest zusammendrücken, dann kontrolliert ablassen.",yt:"glute+bridge+anleitung+anfänger",tag:"Gesäß"},{name:"Wadenheben",detail:"3×30 Sek.",desc:"Mit den Fußballen auf eine Treppenstufe stellen, Fersen hängen frei. Langsam auf die Zehenspitzen hochdrücken, oben kurz halten, dann die Fersen tief absenken für die volle Dehnung. Gleichgewicht an der Wand halten.",yt:"wadenheben+stehend+anleitung+bodyweight",tag:"Waden"},{name:"Dead Bugs",detail:"3×25 Sek./Seite",desc:"Rückenlage, Arme senkrecht zur Decke, Beine im 90°-Winkel angehoben. Gleichzeitig den rechten Arm nach hinten und das linke Bein nach vorne strecken, ohne dass der untere Rücken den Bodenkontakt verliert. Langsam zurück und Seite wechseln.",yt:"dead+bug+übung+core+anleitung+deutsch",tag:"Bauch"},{name:"Side Plank",detail:"3×20 Sek./Seite",desc:"Auf den Unterarm stützen, Ellbogen unter der Schulter. Hüfte anheben bis der Körper eine gerade Linie bildet. Obere Hand auf die Hüfte oder zur Decke strecken. Becken nicht nach vorne oder hinten kippen.",yt:"side+plank+seitstütz+anleitung+deutsch",tag:"Obliques"},{name:"Superman Hold",detail:"3×25 Sek.",desc:"Bauchlage, Arme nach vorne gestreckt. Arme, Brust und Beine gleichzeitig anheben, Gesäß fest anspannen. Blick zum Boden, Nacken in Verlängerung der Wirbelsäule. Position halten.",yt:"superman+übung+rücken+anleitung+bodyweight",tag:"Rücken"}],cooldown:[{name:"Tauben-Stretch",detail:"30 Sek./Seite",desc:"Vorderes Bein angewinkelt vor dem Körper ablegen, hinteres Bein lang nach hinten strecken. Oberkörper aufrecht halten oder nach vorne über das Bein sinken lassen. Tiefe Dehnung in der Hüfte und im Gesäß spüren.",yt:"pigeon+stretch+hüfte+dehnen+anleitung"},{name:"Oberschenkel-Dehnung",detail:"30 Sek./Bein",desc:"Im Stehen einen Fuß zum Gesäß ziehen, Knie zeigen nach unten. Hüfte leicht nach vorne schieben um die Dehnung im vorderen Oberschenkel zu verstärken. Am Stuhl oder der Wand festhalten für Balance.",yt:"quadrizeps+dehnung+stehend+anleitung"},{name:"Wadendehnung",detail:"25 Sek./Seite",desc:"Hände an die Wand, ein Bein nach hinten strecken, Ferse fest in den Boden drücken. Vorderes Knie leicht beugen und die Dehnung in der hinteren Wade spüren.",yt:"wadendehnung+wand+anleitung"}]},
{id:"mi",label:"Mi",title:"Mobility",pauseEx:15,warmup:[{name:"Cat-Cow",detail:"60 Sek.",desc:"Vierfüßlerstand, bewusst langsam zwischen Buckel und Hohlkreuz wechseln. Jede Position 2-3 Atemzüge halten. Auf die Atmung konzentrieren, Bewegung fließend halten.",yt:"cat+cow+übung+anleitung+deutsch"},{name:"Schulter-CARs",detail:"45 Sek./Arm",desc:"Arm langsam in maximalem Radius kreisen — nach vorne, oben, hinten und zurück. Jeden Winkel bewusst durcharbeiten. Der restliche Körper bleibt stabil, nur die Schulter bewegt sich.",yt:"shoulder+CARs+mobility+übung+anleitung"},{name:"Hüft-CARs",detail:"45 Sek./Bein",desc:"Knie auf Hüfthöhe anheben, dann in einem großen Kreis nach außen rotieren. So weit wie möglich öffnen, kontrolliert zurückführen. Oberkörper bleibt ruhig und aufrecht.",yt:"hip+CARs+mobility+übung+hüfte"}],main:[{name:"World's Greatest Stretch",detail:"60 Sek./Seite",desc:"Tiefer Ausfallschritt, Hand neben dem vorderen Fuß aufsetzen. Oberen Arm zur Decke drehen, dem Arm mit dem Blick folgen. In der Endposition atmen und die Dehnung in Hüfte, Brust und Brustwirbelsäule spüren.",yt:"worlds+greatest+stretch+mobility+flow",tag:"Ganzkörper"},{name:"Tiefer Squat-Flow",detail:"2 Min.",desc:"In eine tiefe Hocke gehen, Fersen am Boden. Ellbogen gegen die Knie drücken um die Hüfte zu öffnen. Sanft hin und her wippen, den Oberkörper von einer Seite zur anderen rotieren. Locker und entspannt bleiben.",yt:"deep+squat+hold+mobility+routine",tag:"Hüfte"},{name:"Tauben-Pose",detail:"60 Sek./Seite",desc:"Vorderes Bein angewinkelt ablegen, hinteres Bein lang strecken. Oberkörper aufrecht halten oder langsam nach vorne über das Bein sinken. In die Dehnung atmen, jede Ausatmung etwas tiefer sinken.",yt:"pigeon+pose+yoga+anleitung+deutsch",tag:"Hüfte"},{name:"Brücke vom Boden",detail:"5×20 Sek.",desc:"Rückenlage, Füße aufgestellt. Hüfte hoch drücken, Brust öffnen, Schulterblätter in den Boden drücken. Die gesamte Vorderseite des Körpers öffnet sich. Oben halten, aktiv die Gesäßmuskulatur anspannen.",yt:"glute+bridge+brücke+mobility",tag:"Wirbelsäule"},{name:"Thorakale Rotation",detail:"50 Sek./Seite",desc:"Vierfüßlerstand, eine Hand hinter den Kopf legen. Den Ellbogen langsam zur Decke drehen, Blick folgt. Maximale Rotation in der Brustwirbelsäule suchen. Langsam zurückführen, Bewegung kontrolliert halten.",yt:"thorakale+rotation+vierfüßler+mobilität",tag:"BWS"},{name:"Cobra-Stretch",detail:"5×20 Sek.",desc:"Bauchlage, Hände neben der Brust. Arme langsam strecken, Oberkörper anheben. Hüfte und Beine bleiben am Boden. Schultern von den Ohren weg nach unten ziehen. Sanfte Dehnung, nicht überstrecken.",yt:"cobra+stretch+yoga+rücken+deutsch",tag:"LWS"},{name:"Scorpion-Stretch",detail:"45 Sek./Seite",desc:"Bauchlage, Arme seitlich ausgestreckt. Ein Bein anheben und über den Körper zur gegenüberliegenden Seite führen. Öffnet Brustwirbelsäule und Hüfte gleichzeitig. Schulter bleibt am Boden.",yt:"scorpion+stretch+übung+mobility",tag:"BWS/Hüfte"},{name:"Side Plank",detail:"45 Sek./Seite",desc:"Auf den Unterarm stützen, Hüfte anheben. Oberen Arm zur Decke strecken. Körper bildet eine gerade Linie. Bewusst in den seitlichen Rumpf atmen.",yt:"side+plank+seitstütz+anleitung+deutsch",tag:"Rumpf"},{name:"Dead Bug",detail:"40 Sek./Seite",desc:"Rückenlage, Arme zur Decke, Beine angewinkelt angehoben. Gegengleich einen Arm und das gegenüberliegende Bein strecken, dabei bewusst langsam und kontrolliert. Unterer Rücken bleibt am Boden.",yt:"dead+bug+übung+core+anleitung+deutsch",tag:"Core"}],cooldown:[{name:"Knie zur Brust",detail:"45 Sek./Seite",desc:"Rückenlage, ein Knie sanft mit beiden Händen zur Brust ziehen. Gegenüberliegendes Bein lang am Boden liegen lassen. Unterer Rücken entspannt sich. Tief atmen, jede Ausatmung etwas tiefer ziehen.",yt:"knie+zur+brust+rückenlage+dehnung"},{name:"Wirbelsäulendrehung",detail:"50 Sek./Seite",desc:"Rückenlage, Knie angewinkelt zur Seite fallen lassen. Arme seitlich ausgestreckt, Blick zur gegenüberliegenden Seite. Beide Schultern bleiben am Boden. Dehnung in der seitlichen Wirbelsäule spüren.",yt:"liegende+wirbelsäulendrehung+yoga+anleitung"},{name:"Bauchatmung",detail:"90 Sek.",desc:"Rückenlage, eine Hand auf den Bauch, eine auf die Brust. Tief durch die Nase einatmen, der Bauch hebt sich. Langsam durch den Mund ausatmen, Bauch sinkt. Augen schließen, komplett entspannen und loslassen.",yt:"bauchatmung+entspannung+übung"}]},
{id:"do",label:"Do",title:"Core + Oberkörper",pauseEx:30,warmup:[{name:"Cat-Cow",detail:"45 Sek.",desc:"Buckel und Hohlkreuz.",yt:"cat+cow+übung+anleitung+deutsch"},{name:"World's Greatest Stretch",detail:"30 Sek./Seite",desc:"Ausfallschritt mit Rotation.",yt:"worlds+greatest+stretch+anleitung"},{name:"Schulter-CARs",detail:"30 Sek./Arm",desc:"Große Kreise.",yt:"shoulder+CARs+mobility+übung+anleitung"}],main:[{name:"Hollow Body Hold",detail:"3×30 Sek.",desc:"Bananenform, Rücken am Boden.",yt:"hollow+body+hold+anleitung+anfänger+core",tag:"Bauch"},{name:"Bicycle Crunches",detail:"3×35 Sek.",desc:"Ellbogen zum Gegenknie.",yt:"bicycle+crunches+richtige+ausführung+deutsch",tag:"Obliques"},{name:"Superman Hold",detail:"3×30 Sek.",desc:"Bauchlage, alles anheben.",yt:"superman+übung+rücken+anleitung+bodyweight",tag:"Rücken"},{name:"Dead Bugs",detail:"3×25 Sek./Seite",desc:"Gegengleich strecken.",yt:"dead+bug+übung+core+anleitung+deutsch",tag:"Bauch"},{name:"Side Plank",detail:"3×25 Sek./Seite",desc:"Seitlich, gerade halten.",yt:"side+plank+seitstütz+anleitung+deutsch",tag:"Obliques"},{name:"Plank",detail:"3×40 Sek.",desc:"Unterarme, Körper gerade.",yt:"plank+unterarmstütz+richtige+ausführung",tag:"Core"},{name:"Breite Liegestütze",detail:"3×30 Sek.",desc:"Weiter als schulterbreit.",yt:"breite+liegestütze+ausführung+anleitung",tag:"Brust"},{name:"Tisch-Rudern",detail:"3×30 Sek.",desc:"Enger Griff.",yt:"bodyweight+row+tisch+rudern+zuhause",tag:"Rücken"}],cooldown:[{name:"Brustdehnung Türrahmen",detail:"30 Sek./Seite",desc:"Unterarm am Rahmen.",yt:"brustdehnung+türrahmen+anleitung"},{name:"Kobra-Stretch",detail:"30 Sek.",desc:"Arme strecken.",yt:"cobra+stretch+yoga+rücken+anleitung"},{name:"Seitliche Rumpfdehnung",detail:"25 Sek./Seite",desc:"Arm über Kopf zur Seite.",yt:"seitliche+rumpfdehnung+stehend+anleitung"}]},
{id:"fr",label:"Fr",title:"Ganzkörper + Core",pauseEx:20,warmup:[{name:"Cat-Cow",detail:"60 Sek.",desc:"Buckel und Hohlkreuz.",yt:"cat+cow+übung+anleitung+deutsch"},{name:"Hüft-CARs",detail:"40 Sek./Bein",desc:"Kontrolliert rotieren.",yt:"hip+CARs+mobility+übung+hüfte"},{name:"Arm Circles + Hüftkreise",detail:"60 Sek.",desc:"Armkreise, Hüften kreisen.",yt:"arm+circles+hüftkreise+warmup+anleitung"}],main:[{name:"Squat to Stand",detail:"3×40 Sek.",desc:"Kniebeuge, explosiv hoch.",yt:"squat+to+stand+übung+anleitung",tag:"Ganzkörper"},{name:"Glute Bridge Marsch",detail:"3×40 Sek.",desc:"Brücke, abwechselnd Bein.",yt:"glute+bridge+march+übung+anleitung",tag:"Gesäß"},{name:"Plank Knee Taps",detail:"3×40 Sek.",desc:"Plank, Knie zur Brust.",yt:"plank+knee+taps+übung+anleitung",tag:"Core"},{name:"Liegestütze",detail:"3×40 Sek.",desc:"Volle oder Knie-Variante.",yt:"knie+liegestütze+anfänger+richtige+ausführung",tag:"Brust"},{name:"Birddog",detail:"3×40 Sek.",desc:"Vierfüßler, gegengleich strecken.",yt:"birddog+übung+anleitung+core",tag:"Ganzkörper"},{name:"Plank",detail:"3×40 Sek.",desc:"Unterarme, Körper gerade.",yt:"plank+unterarmstütz+richtige+ausführung",tag:"Core"},{name:"Hollow Body Hold",detail:"3×30 Sek.",desc:"Rückenlage, alles anheben.",yt:"hollow+body+hold+anleitung+anfänger+core",tag:"Bauch"},{name:"Superman Hold",detail:"3×30 Sek.",desc:"Bauchlage, alles anheben.",yt:"superman+übung+rücken+anleitung+bodyweight",tag:"Rücken"}],cooldown:[{name:"Stehende Vorbeuge",detail:"45 Sek.",desc:"Locker nach vorne hängen.",yt:"stehende+vorbeuge+dehnung+anleitung"},{name:"Tauben-Stretch",detail:"45 Sek./Seite",desc:"Intensiver Hüftöffner.",yt:"pigeon+stretch+hüfte+dehnen+anleitung"},{name:"Bauchatmung",detail:"90 Sek.",desc:"Tief atmen, Puls runter.",yt:"bauchatmung+entspannung+übung"}]},
];
